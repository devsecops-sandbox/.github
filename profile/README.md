...
* [Jira Board](https://bijoyfrancis.atlassian.net/jira/software/projects/AD/boards/2)
* GitHub Organizations
    * [BijoyFrancis](https://github.com/BijoyFrancis?tab=repositories)
    * [aadhilabs](https://github.com/orgs/aadhilabs/repositories)
    * [devsecops-sandbox](https://github.com/orgs/devsecops-sandbox/repositories)
    * [devsecops-tests](https://github.com/orgs/devsecops-tests/repositories)

## Lab Build
* Set up home lab using [multipass](https://github.com/devsecops-sandbox/hyperv-lab-multipass/blob/main/README.md).

## Local Lab Applications
* [Uptime Kuma](http://uptime.aadhilabs.com/)
